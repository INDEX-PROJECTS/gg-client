  ...
  return (
    <div className="flex flex-col gap-[16px]">
      ...
      <div>
        ...
        <p className="t3 max-[450px]:t-xs">454008, г. Челябинск, ул. Автодорожная 3, помещение 20</p>
      </div>
      <div>
      ...
      <div>
        <p className="t3 max-[450px]:t-xs !font-[700]">Адрес склада</p>
        <p className="t3 max-[450px]:t-xs">454008, г. Челябинск, ул. Автодорожная 3</p>
      </div>
    </div>
  );
};
